   ...
   [:div
    ...
    [:div
     ...
     [:div
      ...
      [:div
       {:class "mb-14 before:block before:w-24 before:h-3 before:mb-5 before:rounded-md before:mx-0 before:bg-gray-200"}
       [:h3 {:class "text-3xl font-semibold"} "Sithabiso Makhathini"]
       [:span
        {:class "text-sm font-bold tracking-wider uppercase text-gray-300"}
        "What I have been up to"]]]
     [:div
      {:class "relative col-span-12 space-y-6 sm:col-span-9"}
      [:div
       {:class "col-span-12 space-y-12 relative sm:px-4 sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:bg-gray-200"}
       [:div
        {:class "flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-gray-400"}
        [:h3
         {:class "text-xl font-semibold tracking-wide text-gray-700"}
        ...
        [:p
         {:class "mt-3"}
         "Currently working as a Mid Software Engineer at Simply, where I am responsible for the design and implementation of new features, as well as the maintenance and support of existing systems."]]
       [:div
        {:class "flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-gray-400"}
        [:h3
         {:class "text-xl font-semibold tracking-wide  text-gray-700"}
